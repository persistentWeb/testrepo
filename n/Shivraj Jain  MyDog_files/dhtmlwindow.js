...
var dhtmlwindow={
imagefiles:['js/modalwindow/min.gif', 'js/modalwindow/close.gif', 'js/modalwindow/restore.gif', 'js/modalwindow/resize.gif'], //Path to 4 images used by script, in that order
...
init:function(t){
	...
	this.zIndexvalue=(this.zIndexvalue)? this.zIndexvalue+1 : 1105 //z-index value for DHTML window: starts at 0, increments whenever a window has focus
...
open:function(t, contenttype, contentsource, title, attr, recalonload){
	...
	var xpos=getValue("center1")? "middle" : getValue("left") //Get x coord of window

	var ypos=getValue("center1")? "middle" : getValue("top") //Get y coord of window
